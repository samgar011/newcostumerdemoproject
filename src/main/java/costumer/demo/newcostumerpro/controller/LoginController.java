...
import costumer.demo.newcostumerpro.config.NewOAuthSuccessHandler;
...
public class LoginController {
    ...
    @PostMapping("/register")
        public String singUp(@ModelAttribute("user") User user, HttpServletRequest request ) throws ServletException {
